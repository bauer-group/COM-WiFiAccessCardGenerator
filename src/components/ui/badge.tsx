  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--ring)] focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success: 'border-transparent bg-[var(--success-bg)] text-green-700 dark:text-green-300',
        warning: 'border-transparent bg-[var(--warning-bg)] text-yellow-700 dark:text-yellow-300',
      },
    },
    defaultVariants: {
      variant: 'default',
